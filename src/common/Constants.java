...
{
	//DEBUG
	public static int DEBUG_MAP_LIMIT 	=	10000;
	//Server
	public static final String SERVER_VERSION	=	"2.0.6";
	public static final String SERVER_MAKER		=	"MarthieuBean";
	//Versions
...
/*		STAT_W8.put(Constants.STATS_ADD_VITA,1);	//Rune vi		
	...
	public static final int[] BEGIN_TURN_BUFF	=	{91,92,93,94,95,96,97,98,99,100};
	//Buff des Armes
	...
	public static ObjTemplate getParchoTemplateByMountColor(int color)
	{
		switch(color)
		{
			...
			//Prune-Pourpre
			case 87: return World.getObjTemplate(7839);
			//Armure
